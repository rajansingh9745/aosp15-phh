...
git clone https://github.com/rajansingh9745/vendor_hardware_overlay -b pie vendor/hardware_overlay

echo "Cloning TrebleDroid/vendor_interfaces..."
git clone https://github.com/rajansingh9745/vendor_interfaces -b android-15.0 vendor/interfaces
...
git clone https://github.com/rajansingh9745/vendor_magisk -b android-10.0 vendor/magisk

echo "Cloning AndyCGYan/android_packages_apps_QcRilAm..."
git clone https://github.com/rajansingh9745/android_packages_apps_QcRilAm -b master packages/apps/QcRilAm
